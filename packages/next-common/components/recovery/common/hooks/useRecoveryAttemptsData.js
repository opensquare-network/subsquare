...
/**
 * Base hook that fetches all recovery attempts and their friend groups.
 *
 * @returns {{ attempts: Array, loading: boolean, fetch: () => void, friendGroupsMap: object }}
 *   - attempts: all processed recovery attempt objects
 ...
 */
export default function useRecoveryAttemptsData() {
  ...
  return { attempts, loading, fetch, friendGroupsMap };
}
