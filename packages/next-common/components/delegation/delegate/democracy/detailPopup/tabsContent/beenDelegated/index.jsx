...
import ReferendaDelegateeDetailPopupBeenDelegatedInfo from "next-common/components/delegation/delegate/referenda/detailPopup/tabsContent/beenDelegated/info";
import DelegatorList from "next-common/components/delegation/delegate/referenda/detailPopup/tabsContent/beenDelegated/delegatorList";

export default function DemocracyDelegateeDetailPopupBeenDelegated({
  delegate,
}) {
  const { symbol, decimals } = useChainSettings();
  const { isLoading, beenDelegatedList } = useBeenDelegated(delegate.address);
