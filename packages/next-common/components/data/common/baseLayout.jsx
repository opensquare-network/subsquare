      ...
      <div
        ...
        style={{
          "--event-light-background":
            "url('@osn/icons/src/subsquare_public/project-page-bg-data-light.svg'), repeat, linear-gradient(180deg, #FDFDFD 0%, #F6F7FA 100%)",
          "--event-dark-background":
            "url('@osn/icons/src/subsquare_public/project-page-bg-data-dark.svg'), repeat, linear-gradient(180deg, #212433 0%, #1E2130 100%)",
        }}
      >
