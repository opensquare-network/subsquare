...
export default function AuthoritySelect({ value = NONE, onChange = noop }) {
  ...
  return (
    ...
    >
      <RadixSelect.Trigger className="text12Medium flex justify-between items-center min-w-5 w-[160px] h-[28px] bg-neutral100 border border-neutral400 cursor-pointer text-textPrimary rounded-md py-1.5 px-1.5 pl-4">
