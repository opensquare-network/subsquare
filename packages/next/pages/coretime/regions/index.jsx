...
import CoretimeRegions from "next-common/components/coretime/regions";
...
export default function CoretimeRegionsPage() {
  if (!isCoretimeSupported) {
    return null;
  }
...
function CoretimeRegionsPageImpl() {
  const title = "Regions";
  const description = "Coretime regions and their ownership";
