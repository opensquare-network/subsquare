...
router.patch(
  "/democracy/externals/:postId",
  requireAuth,
  proposalController.updatePost
);

router.post(
  "/democracy/externals/:postId/comments",
  requireAuth,
  requireVerify,
  proposalController.postComment
);

router.get(
  "/democracy/externals/:postId/comments",
  proposalController.getComments
);
